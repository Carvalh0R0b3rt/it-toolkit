    ...
    <div className="h-screen w-screen overflow-hidden flex">
      ...
      <div className="w-64 shrink-0 border-r border-border flex flex-col bg-background">
        ...
        <div className="px-5 py-5 border-b border-border">
          <h1 className="font-mono-ui text-sm font-bold uppercase tracking-widest text-primary">
            MarketOps
          </h1>
        </div>
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`w-full text-left px-5 py-3 font-mono-ui text-xs uppercase tracking-widest transition-colors ${
                activeTab === tab.key
                  ? "text-primary border-l-2 border-primary bg-card"
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="border border-border bg-card p-3">
                    ...
                    <p className="font-mono-ui text-lg font-bold text-primary">200.1K</p>
                  </div>
                  <div className="border border-border bg-card p-3">
                    <p className="font-mono-ui text-[10px] uppercase text-muted-foreground">Active Workflows</p>
                    <p className="font-mono-ui text-lg font-bold text-primary">12</p>
                  </div>
                  <div className="border border-border bg-card p-3">
                    <p className="font-mono-ui text-[10px] uppercase text-muted-foreground">Campaigns MTD</p>
                    <p className="font-mono-ui text-lg font-bold text-primary">8</p>
                  </div>
                </div>
              </div>
            </div>
